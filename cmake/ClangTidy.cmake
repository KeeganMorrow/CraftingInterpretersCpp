function(clangtidy_addtarget target)
    ...
    if(RUN_CLANG_TIDY_BIN)
        add_custom_target(
            clangtidy_${target}
            WORKING_DIRECTORY ${TARGET_SOURCEDIR}
            COMMAND
                ${RUN_CLANG_TIDY_BIN} ${MYSOURCES}
                -header-filter='${TARGET_SOURCEDIR}/src/.*|${TARGET_SOURCEDIR}/test/.*|${TARGET_SOURCEDIR}/include/.*'
        )
    ...
    if(NOT TARGET clangtidy AND TARGET clangtidy_${target})
        ...
        if(NOT TARGET lint)
            ...
            add_dependencies(lint clangtidy)
        endif()
    else()
