...
public:
    ...
    [[nodiscard]] std::string visitBinary(const Binary& expression) const override;
    [[nodiscard]] std::string visitGrouping(const Grouping& expression) const override;
    [[nodiscard]] std::string visitLiteral(const Literal& expression) const override;
